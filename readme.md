...
# Instalasi
### Deploy :
[![Deploy with Heroku](https://www.herokucdn.com/deploy/button.svg "Deploy with Heroku")](https://heroku.com/deploy?template=https://github.com/ZasXCar/WhatsBot "Deploy with Heroku")<br>
...
# Instalasi
### Deploy :
[![Deploy with Heroku](https://www.herokucdn.com/deploy/button.svg "Deploy with Heroku")](https://heroku.com/deploy?template=https://github.com/ZasXCar/BaseSelfBot "Deploy with Heroku")<br>
Read the [wiki](https://github.com/TheWhatsBot/WhatsBot/wiki/Deploy-with-Heroku) before Deploy it with Heroku<br><br>
[Deploy in VPS](https://github.com/TheWhatsBot/WhatsBot/wiki/Deploy-in-VPS)
## Clone Repo & Instalasi dependencies
```bash
> git clone https://github.com/ZasXCar/BaseSelfBot.git
> cd BaseSelfBot
> npm install
> node xinz
```
...
## Edit file
- Change menu [disini](https://github.com/ZasXCar/BaseSelfBot/blob/master/xinz.js#95)
- Change prefix [disini](https://github.com/ZasXCar/BaseSelfBot/blob/master/xinz.js#35)
- Change faketeks [disini](https://github.com/ZasXCar/BaseSelfBot/blob/master/xinz.js#33)
- Change gambar [disini](https://github.com/ZasXCar/BaseSelfBot/blob/master/media/aqul.jpeg) di replace gambar nya dan jangan diubah namanya
- Bisa juga ganti biar jadi forwarded message
```js
aqul.sendFakeStatus(from, teks, fake)
// bisa diubah menjadi
